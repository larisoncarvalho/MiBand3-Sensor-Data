...
class UUIDS(object):
    ...
    CHARACTERISTIC_SENSOR_DATA = "00000002-0000-3512-2118-0009af100700" #handle 0x0035
    CHARACTERISTIC_SENSOR_CONTROL = "00000001-0000-3512-2118-0009af100700" #0x0032
    CHARACTERISTIC_AUTH = "00000009-0000-3512-2118-0009af100700"
    CHARACTERISTIC_HEART_RATE_MEASURE = "00002a37-0000-1000-8000-00805f9b34fb" #handle 0x0029
    CHARACTERISTIC_HEART_RATE_CONTROL = "00002a39-0000-1000-8000-00805f9b34fb" #handle 0x002c
    ...
    # CHARACTERISTIC_REALTIME_STEPS = BASE % 'FF06'
    # CHARACTERISTIC_SENSOR_CONTROL_DATA = BASE % 'FF0E'
